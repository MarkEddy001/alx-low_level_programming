...
The C preprocessor modifies a source code file before handing it over to the compiler. The C Pre-processor is not part of the compiler but it's a step executed before the source code is compiled.
